 ...
 *
 * wp_clear_scheduled_hook() removes every scheduled occurrence of the hook in
 * one call, but only for the current site's cron array — so on multisite we
 * call this once per site below.
 *
