...
the reviewed release asset installs, and each release carries a build-provenance
attestation and a SHA-256 checksum you can verify. If you fork the plugin to serve
